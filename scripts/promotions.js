...
promoArray.push(new Promo(
    "slides/prawn.jpg",
    "Spot Prawn Special",
    "Dive into the freshness of the sea with our Spot Prawn special! <br/><br/>Purchase our select packages and experience the unparalleled taste of these juicy, succulent prawns. Freshly caught and perfectly seasoned, these prawns are the epitome of oceanic delight. <br/><br/>But that's not all! With every package, you get a special spot prawn recipe booklet, filled with innovative and mouth-watering dishes you can whip up in your kitchen. <br/><br/>This special promo is available for a limited time. Visit us today and take home the fresh, delicious goodness of Spot Prawns",
    "04-Jun",
    "30-Jun"
));

promoArray.push(new Promo(
    "slides/instantNoodles.jpg",
    "LM Noodles Sale",
    "Don't miss our amazing deal on instant noodles! <br/><br/>For a limited time only, you can get 3 packs of instant noodles for just $0.99. <br/><br/>Perfect for a quick meal or a midnight snack, our instant noodles are simple to prepare and delicious to eat. <br/><br/>Take advantage of this offer and stock up on your favorite flavors today. <br/><br/>Visit us today and don't miss out!",
    "10-May",
    "10-Jun"
));
function setPromo(i) {
    ...
    $("#promo-start").html("Starts: "+promoArray[i].startDate);
    $("#promo-end").text("Ends: "+promoArray[i].endDate)
}
